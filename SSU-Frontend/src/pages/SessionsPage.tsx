              ...
              >
                ...
                {isProgramada ? (
                  <button
                    ...
                    className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-sm transition-all flex-shrink-0 font-nunito-sans font-bold"
                  ...
                  <span className="hidden sm:block text-xs px-2.5 py-1 rounded-full flex-shrink-0 font-nunito-sans font-bold"
